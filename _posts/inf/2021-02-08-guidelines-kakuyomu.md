...
<span class="small">(Click/ touch image to enlarge it)</span>
{: style="text-align: center" }
<noscript>(To enlarge images on click your browser must support JavaScript)<br> <br></noscript>
...
![reg2](/src/img/kakuyomu-guide/omg-kakuyomu-reg2.png){: class="white-img" onclick="window.open(this.src)"}

After some time you'll receive an e-mail message. Just follow the web-link in it. <br /><br /> For further logging in, click here---

![log-in-1](/src/img/kakuyomu-guide/omg-kakuyomu-log-in.png){: class="white-img" onclick="window.open(this.src)"}
...
![email1](/src/img/kakuyomu-guide/omg-kakuyomu-no-email1.png){: class="white-img" onclick="window.open(this.src)"}

Next, choose a second tab and scroll to the very bottom.

![email2](/src/img/kakuyomu-guide/omg-kakuyomu-no-email2.png){: class="white-img" onclick="window.open(this.src)"}

Check the boxes circled on image below and click a blue button.

![email3](/src/img/kakuyomu-guide/omg-kakuyomu-no-email3.png){: class="white-img" onclick="window.open(this.src)"}
