...
After a month at [*WordPress*](https://sakkamade.wordpress.com/) I decided to move to [*GitHub*](https://github.com/) and [*Jekyll*](https://jekyllrb.com/).
...
<h4 class="with-indent"> Services I use for translating </h4>

[jisho.org](https://jisho.org/)
[translate.google.com](https://translate.google.com/?hl=en&amp;tab=TT)
[wikionary.com](https://en.wiktionary.org/wiki/Wiktionary:Main_Page)
and plenty of other.

<div style="height:200px;"> </div>

<blockquote><strong style="font-size:25px;">継続は力なり。</strong><em style="font-size:13px;">Keizoku wa Chikara nari.</em><br>
<a href="https://en.wikiquote.org/wiki/Japanese_proverbs"><em style="font-size:16px;">wikiquote.org</em></a></blockquote>
